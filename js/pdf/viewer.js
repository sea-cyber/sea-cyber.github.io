'use strict';
var DEFAULT_URL = '../image/test.pdf';
...
PDFJS.imageResourcesPath = '../image/pdf/';
    ...
    PDFFindBar.prototype = {
        ...
        updateUIState:
            function PDFFindBar_updateUIState(state, previous, matchCount) {
                ...
                var status = '';
                switch (state) {
                    case FindStates.FIND_FOUND: break;
...
function webViewerInitialized() {
    ...
    document.getElementById('viewThumbnail').addEventListener('click',
      function () { PDFViewerApplication.switchSidebarView('thumbs'); });
    document.getElementById('viewOutline').addEventListener('click',
      function () { PDFViewerApplication.switchSidebarView('outline'); });
    document.getElementById('viewOutline').addEventListener('dblclick',
      function () { PDFViewerApplication.outline.toggleOutlineTree(); });
    document.getElementById('viewAttachments').addEventListener('click',
      function () { PDFViewerApplication.switchSidebarView('attachments'); });
