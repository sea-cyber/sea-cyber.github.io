...
(function ($) {
    ...
    function _8d(_8e) {
        ...
        /*strat cwj 设置按钮的背景色和字体颜色*/
        if (_8f.BgColor)
            $(t).css({
                "background": _8f.BgColor,
                "background": _8f.BgColor,
                "background-repeat": "repeat-x",
                "background": "-webkit-linear-gradient(top," + _8f.BgColor + " 0," + _8f.BgColor + " 100%)",
                "background": "-moz-linear-gradient(top," + _8f.BgColor + " 0," + _8f.BgColor + " 100%)",
                "background": "-o-linear-gradient(top," + _8f.BgColor + " 0," + _8f.BgColor + " 100%)",
                "background": "linear-gradient(to bottom," + _8f.BgColor + " 0," + _8f.BgColor + " 100%)",
                "background-repeat": "repeat-x",
                "filter": "progid:DXImageTransform.Microsoft.gradient(startColorstr=" + _8f.BgColor + ",endColorstr=" + _8f.BgColor + ",GradientType=0)"
            });
        if (_8f.Color) $(t).css({ "color": _8f.Color });
        if (_8f.Border) $(t).css({ "border": _8f.Border });
        /*end cwj */
        if (_8f.plain) {
...
(function ($) {
    ...
    $.fn.pagination.parseOptions = function (_c6) {
        var t = $(_c6);
        return $.extend({}, $.parser.parseOptions(_c6, [{ total: "number", pageSize: "number", pageNumber: "number", links: "number" }, {
...
(function ($) {
    ...
    function _15b(_15c, _15d) {
        ...
        _157(_15c, {
            parent: (_15e ? _15e.target : null), data: data
        });
    ...
    $.fn.tree = function (_1a0, _1a1) {
        ...
        return this.each(function () {
            ...
            if (_1a2) {
                ...
                $.data(this, "tree", {
                    options: opts, tree: _d5(this), data: []
                });
            ...
            function _1c5(_1c6, _1c7) {
                ...
                for (var i = 0; i < _1c7.length; i++) {
                    ...
                    if (item.state == "closed") {
                        ...
                        //zzy 2016-09-08
                        cc.push("<span style=\"display:" + (item.iconCls == "none" ? "none" : "") + "\" class=\"tree-icon tree-folder " + (item.iconCls ? item.iconCls : "") + "\"></span>");
                    } else {
                        if (item.children && item.children.length) {
                            cc.push("<span class=\"tree-hit tree-expanded\"></span>");
                            //zzy 2016-09-08
                            cc.push("<span style=\"display:" + (item.iconCls == "none" ? "none" : "") + "\" class=\"tree-icon tree-folder tree-folder-open " + (item.iconCls ? item.iconCls : "") + "\"></span>");
                        } else {
                            //zzy 2016-09-08
                            cc.push("<span style=\"display:" + (item.iconCls == "none" ? "none" : "") + "\" class=\"tree-indent\"></span>");
                            cc.push("<span style=\"display:" + (item.iconCls == "none" ? "none" : "") + "\" class=\"tree-icon tree-file " + (item.iconCls ? item.iconCls : "") + "\"></span>");
                            _1c8 = true;
                        }
                    }
                    if (opts.checkbox) {
        ...
        return this.each(function () {
            ...
            if (_1e4) {
                ...
                _1e4 = $.data(this, "progressbar", {
                    options: $.extend({}, $.fn.progressbar.defaults, $.fn.progressbar.parseOptions(this), _1e1), bar: init(this)
                });
            }
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_258) {
                ...
                _258 = $.data(this, "panel", {
                    options: opts, panel: _219(this), isLoaded: false
                });
            }
            _21d(this);
            if (opts.doSize == true) {
    ...
    $.fn.panel.parseOptions = function (_266) {
        ...
        return $.extend({}, $.parser.parseOptions(_266, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", "method", "header", "footer", { cache: "boolean", fit: "boolean", border: "boolean", noheader: "boolean" }, { collapsible: "boolean", minimizable: "boolean", maximizable: "boolean" }, { closable: "boolean", collapsed: "boolean", minimized: "boolean", maximized: "boolean", closed: "boolean" }, "openAnimation", "closeAnimation", { openDuration: "number", closeDuration: "number" }, ]), {
    ...
    $.fn.panel.defaults = {
        ...
        }, href: null, cache: true, fit: false, border: true, doSize: true, noheader: false, content: null, collapsible: false, minimizable: false, maximizable: false, closable: false, collapsed: false, minimized: false, maximized: false, closed: false, openAnimation: false, openDuration: 400, closeAnimation: false, closeDuration: 400, tools: null, footer: null, header: null, queryParams: {}, method: "get", href: null, loadingMessage: "Loading...", loader: function (_267, _268, _269) {
...
(function ($) {
    ...
    $.fn.window.getMaskSize = function (_28d) {
        ...
        return {
            width: (_28f ? "100%" : $(document).width()), height: (_28f ? "100%" : $(document).height())
        };
    };
...
(function ($) {
    ...
    function _2a6(_2a7) {
        var opts = $.extend({}, $.messager.defaults, {
            modal: false, shadow: false, draggable: false, resizable: false, closed: true, style: {
    ...
    $.messager = {
        show: function (_2ab) {
            ...
            var opts = typeof _2ac == "object" ? _2ac : {
                title: _2ac, msg: msg, icon: icon, fn: fn
            };
            ...
            var win = _2a9($.extend({}, $.messager.defaults, {
                content: "<div class=\"messager-progress\"><div class=\"messager-p-msg\">" + opts.msg + "</div><div class=\"messager-p-bar\"></div></div>", closable: false, doSize: false
            }, opts, {
                onClose: function () {
                    if (this.timer) {
        ...
        function _2ba(_2bb, _2bc) {
            ...
            for (var i = 0; i < _2b6.length; i++) {
                ...
                if (p.panel("options").collapsible == _2bb) {
                    ...
                    p.panel("resize", {
                        width: cc.width(), height: (_2bb ? _2be : undefined)
                    });
    ...
    $.fn.accordion = function (_2f7, _2f8) {
        ...
        return this.each(function () {
            ...
            if (_2f9) {
                ...
                $.data(this, "accordion", {
                    options: $.extend({}, $.fn.accordion.defaults, $.fn.accordion.parseOptions(this), _2f7), accordion: $(this).addClass("accordion"), panels: []
                });
                init(this);
            }
            _2cf(this);
...
(function ($) {
    ...
    function _30d(_30e) {
        ...
        if (_313 > _314) {
            ...
            if (opts.toolPosition == "left") {
                ...
                wrap.css({
                    marginLeft: tool._outerWidth(), marginRight: 0, width: _314
                });
            } else {
                tool.css({
                    left: "", right: 0
                ...
                wrap.css({
                    marginLeft: 0, marginRight: tool._outerWidth(), width: _314
                });
            }
        }
    };
    ...
    function _33a(_33b, _33c, pp) {
        ...
        $(_33b).tabs("update", {
            tab: pp, options: pp.panel("options"), type: "header"
        });
    };
    ...
    $.fn.tabs = function (_373, _374) {
        ...
        return this.each(function () {
            ...
            if (_375) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _373), tabs: [], selectHis: []
                });
                _32b(this);
            }
            _315(this);
...
(function ($) {
    ...
    function _393(_394, _395) {
        ...
        function _398(pp, type) {
            ...
            var opts = pp.panel("options");
            pp.panel("resize", {
                width: cc.width(), height: opts.height
            });
        ...
        function _39a(pp, type) {
            ...
            var opts = pp.panel("options");
            pp.panel("resize", {
                width: opts.width, height: cpos.height
            });
    ...
    function _3a0(_3a1, _3a2, el) {
        ...
        var _3a4 = $.extend({}, $.fn.layout.paneldefaults, {
            ...
            cls: ((_3a2.cls || "") + " layout-panel layout-panel-" + dir), bodyCls: ((_3a2.bodyCls || "") + " layout-body")
        });
        pp.panel(_3a4);
        _3a3[dir] = pp;
        var _3a7 = {
    ...
    function _3b2(_3b3, _3b4, _3b5) {
        ...
        function _3bb() {
            ...
            if (_3b4 == "east") {
                ...
                return {
                    resizeC: { width: _3c0 }, expand: { left: cc.width() - _3bf }, expandP: { top: _3bd.top, left: cc.width() - _3be, width: _3be, height: _3bd.height }, collapse: { left: cc.width(), top: _3bd.top, height: _3bd.height }
                };
            } else {
                if (_3b4 == "west") {
                    var _3bf = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: { width: _3c0, left: _3be - 1 }, expand: { left: 0 }, expandP: { left: 0, top: _3bd.top, width: _3be, height: _3bd.height }, collapse: { left: -_3bf, top: _3bd.top, height: _3bd.height }
                    };
                } else {
                    if (_3b4 == "north") {
                        ...
                        return {
                            resizeC: { top: _3be - 1, height: hh }, expand: { top: 0 }, expandP: { top: 0, left: 0, width: cc.width(), height: _3be }, collapse: { top: -_3c1, width: cc.width() }
                        };
                    } else {
                        if (_3b4 == "south") {
                            var _3c1 = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: { height: hh }, expand: { top: cc.height() - _3c1 }, expandP: { top: cc.height() - _3be, left: 0, width: cc.width(), height: _3be }, collapse: { top: cc.height(), width: cc.width() }
                            };
                        }
                    }
                }
    ...
    function _3c2(_3c3, _3c4) {
        ...
        function _3c9() {
            ...
            if (_3c4 == "east" && _3c5.expandEast) {
                return {
                    collapse: { left: cc.width(), top: _3ca.top, height: _3ca.height }, expand: { left: cc.width() - p.panel("panel")._outerWidth() }
                };
            } else {
                if (_3c4 == "west" && _3c5.expandWest) {
                    return {
                        collapse: { left: -p.panel("panel")._outerWidth(), top: _3ca.top, height: _3ca.height }, expand: {
                            left: 0
                        }
                    };
                } else {
                    if (_3c4 == "north" && _3c5.expandNorth) {
                        return {
                            collapse: { top: -p.panel("panel")._outerHeight(), width: cc.width() }, expand: { top: 0 }
                        };
                    } else {
                        if (_3c4 == "south" && _3c5.expandSouth) {
                            return {
                                collapse: { top: cc.height(), width: cc.width() }, expand: { top: cc.height() - p.panel("panel")._outerHeight() }
                            };
                        }
                    }
                }
    ...
    $.fn.layout = function (_3d5, _3d6) {
        ...
        return this.each(function () {
            ...
            if (_3d7) {
                ...
                $.data(this, "layout", {
                    options: opts, panels: { center: $(), north: $(), south: $(), east: $(), west: $() }
                });
                init(this);
            }
            _393(this);
    ...
    $.fn.layout.parsePanelOptions = function (_3e1) {
        ...
        return $.extend({}, $.fn.panel.parseOptions(_3e1), $.parser.parseOptions(_3e1, ["region", {
            split: "boolean", collpasedSize: "number", minWidth: "number", minHeight: "number", maxWidth: "number", maxHeight: "number"
        }]));
    };
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        resizable: true, region: null, split: false, collapsedSize: 28, minWidth: 10, minHeight: 10, maxWidth: 10000, maxHeight: 10000
    });
})(jQuery);
(function ($) {
    $(function () {
...
(function ($) {
    ...
    function _432(_433) {
        ...
        if (mm.length) {
            ...
            mm.menu("show", {
                alignTo: btn, align: opts.menuAlign
            });
        }
        btn.blur();
    };
    ...
    $.fn.menubutton.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "menubutton").options, {
                toggle: _438.toggle, selected: _438.selected, disabled: _438.disabled
            });
        }, destroy: function (jq) {
            return jq.each(function () {
    ...
    $.fn.menubutton.defaults = $.extend({}, $.fn.linkbutton.defaults, {
        plain: true, hasDownArrow: true, menu: null, menuAlign: "left", duration: 100, cls: {
...
(function ($) {
    ...
    $.fn.splitbutton.defaults = $.extend({}, $.fn.linkbutton.defaults, {
        plain: true, menu: null, duration: 100, cls: {
            btn1: "m-btn-active s-btn-active", btn2: "m-btn-plain-active s-btn-plain-active", arrow: "m-btn-downarrow", trigger: "m-btn-line"
        }
    });
})(jQuery);
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_46a) {
                ...
                _46a = $.data(this, "switchbutton", {
                    options: $.extend({}, $.fn.switchbutton.defaults, $.fn.switchbutton.parseOptions(this), _468), switchbutton: init(this)
                });
            }
...
(function ($) {
    ...
    function _4c1(_4c2) {
        ...
        if (!opts.disabled && !opts.readonly) {
            _4c4.bind("blur.textbox", function (e) {
                /*start cwj 获取焦点不显示阴影 2016-05-11*/
                if (!tb.hasClass("textbox-focused") && !opts.noShadow) {
                    return;
                }
                /*end cwj 获取焦点不显示阴影 2016-05-11*/
                opts.value = $(this).val();
                if (opts.value == "") {
                ...
                $(this).removeClass("textbox-prompt");
                /*start cwj 获取焦点不显示阴影 2016-05-11*/
                if (!opts.noShadow) tb.addClass("textbox-focused");
                /*end*/
            });
        ...
        return this.each(function () {
            ...
            if (_4d4) {
                ...
                _4d4 = $.data(this, "textbox", {
                    options: $.extend({}, $.fn.textbox.defaults, $.fn.textbox.parseOptions(this), _4d0), textbox: init(this)
                });
    ...
    $.fn.textbox.methods = {
        options: function (jq) {
            ...
            return jq.each(function () {
                ...
                span.find("input.textbox-value").attr("name", name);
                $.data(this, "textbox", {
                    options: $.extend(true, {}, $(from).textbox("options")), textbox: span
                });
    ...
    $.fn.textbox.parseOptions = function (_4e3) {
        var t = $(_4e3);
        return $.extend({
        }, $.fn.validatebox.parseOptions(_4e3), $.parser.parseOptions(_4e3, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", { multiline: "boolean", editable: "boolean", iconWidth: "number" }]), { value: (t.val() || undefined), type: (t.attr("type") ? t.attr("type") : undefined), disabled: (t.attr("disabled") ? true : undefined), readonly: (t.attr("readonly") ? true : undefined) });
    };
...
(function ($) {
    ...
    $.fn.filebox.parseOptions = function (_4f1) {
        return $.extend({
        }, $.fn.textbox.parseOptions(_4f1), {});
    };
    $.fn.filebox.defaults = $.extend({}, $.fn.textbox.defaults, {
        buttonIcon: null, buttonText: "Choose File", buttonAlign: "right", inputEvents: {}
    });
})(jQuery);
(function ($) {
    function _4f2(_4f3) {
        ...
        function _4f9(item) {
            ...
            $(_4f3).textbox("button").menubutton({
                text: item.text, iconCls: (item.iconCls || null), menu: _4f4.menu, menuAlign: opts.buttonAlign, plain: false
            });
    ...
    $.fn.searchbox.parseOptions = function (_501) {
        var t = $(_501);
        return $.extend({
        }, $.fn.textbox.parseOptions(_501), $.parser.parseOptions(_501, ["menu"]), { searcher: (t.attr("searcher") ? eval(t.attr("searcher")) : undefined) });
    };
...
(function ($) {
    ...
    $.fn.form.parseOptions = function (_52e) {
        var t = $(_52e);
        return $.extend({
        }, $.parser.parseOptions(_52e, [{ ajax: "boolean" }]), { url: (t.attr("action") ? t.attr("action") : undefined) });
    };
    $.fn.form.defaults = {
...
(function ($) {
    ...
    $.fn.numberbox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "numberbox").options, {
                width: opts.width, originalValue: opts.originalValue, disabled: opts.disabled, readonly: opts.readonly
            });
        },
        fix: function (jq) {
            return jq.each(function () {
    ...
    $.fn.numberbox.parseOptions = function (_540) {
        var t = $(_540);
        return $.extend({
        }, $.fn.textbox.parseOptions(_540), $.parser.parseOptions(_540, ["decimalSeparator", "groupSeparator", "suffix", { min: "number", max: "number", precision: "number" }]), { prefix: (t.attr("prefix") ? t.attr("prefix") : undefined) });
    };
    $.fn.numberbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        ...
        min: null, max: null, precision: 0, decimalSeparator: ".", groupSeparator: "", prefix: "", suffix: "",
        filter: function (e) {
...
(function ($) {
    function _545(_546, _547) {
        ...
        if (_547) {
            $.extend(opts, {
                width: _547.width, height: _547.height
            });
        }
        ...
        options: function (jq) {
            ...
            return jq.each(function () {
                if (!date) {
                    var now = new Date();
                    $(this).calendar({
                        year: now.getFullYear(), month: now.getMonth() + 1, current: date
                    });
                    return;
                }
...
(function ($) {
    ...
    $.fn.spinner.parseOptions = function (_582) {
        return $.extend({
        }, $.fn.textbox.parseOptions(_582), $.parser.parseOptions(_582, ["min", "max", {
            increment: "number"
        }]));
    };
...
(function ($) {
    ...
    $.fn.numberspinner.parseOptions = function (_58b) {
        return $.extend({
        }, $.fn.spinner.parseOptions(_58b), $.fn.numberbox.parseOptions(_58b), {});
    };
...
(function ($) {
    ...
    $.fn.timespinner.parseOptions = function (_5aa) {
        return $.extend({
        }, $.fn.spinner.parseOptions(_5aa), $.parser.parseOptions(_5aa, ["separator", {
...
(function ($) {
    ...
    $.fn.datetimespinner.parseOptions = function (_5b4) {
        return $.extend({
        }, $.fn.timespinner.parseOptions(_5b4), $.parser.parseOptions(_5b4, []));
    };
...
(function ($) {
    ...
    function _5f7(_5f8, _5f9) {
            ...
            $(_5f8).children("thead").each(function () {
                ...
                $(this).find("tr").each(function () {
                    ...
                    $(this).find("th").each(function () {
                        var th = $(this);
                        var col = $.extend({
                        }, $.parser.parseOptions(this, ["field", "align", "halign", "order", "width", { sortable: "boolean", checkbox: "boolean", resizable: "boolean", fixed: "boolean" }, { rowspan: "number", colspan: "number" }]), { title: (th.html() || undefined), hidden: (th.attr("hidden") ? true : undefined), formatter: (th.attr("formatter") ? eval(th.attr("formatter")) : undefined), styler: (th.attr("styler") ? eval(th.attr("styler")) : undefined), sorter: (th.attr("sorter") ? eval(th.attr("sorter")) : undefined) });
        ...
        return {
            panel: _5fd, frozenColumns: cc[0], columns: cc[1], dc: { view: view, view1: _5fe, view2: _5ff, header1: _5fe.children("div.datagrid-header").children("div.datagrid-header-inner"), header2: _5ff.children("div.datagrid-header").children("div.datagrid-header-inner"), body1: _5fe.children("div.datagrid-body").children("div.datagrid-body-inner"), body2: _5ff.children("div.datagrid-body"), footer1: _5fe.children("div.datagrid-footer").children("div.datagrid-footer-inner"), footer2: _5ff.children("div.datagrid-footer").children("div.datagrid-footer-inner") }
        };
    };
    function _600(_601) {
        ...
        _61a.each(function () {
            $(this).resizable({
                handles: _61d, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    ...
                    _617.proxy.css({
                        left: e.pageX - $(_618).offset().left - 1, display: "none"
                    });
                    setTimeout(function () {
                        if (_617.proxy) {
                            _617.proxy.show();
                    ...
                    _617.proxy.css({
                        left: e.pageX - $(_618).offset().left - 1, display: "block"
                    });
                    return false;
                }, onStopResize: function (e) {
                    _619.css("cursor", "");
    ...
    function _63b(_63c, _63d) {
        ...
        var _63f = {
            sortName: opts.sortName, sortOrder: opts.sortOrder
        };
        ...
        function _64e() {
            ...
            for (var i = 0; i < _650.length; i++) {
                ...
                if (_651(col)) {
                    _64f += col.width;
                    cc.push({
                        field: col.field, col: col, addingWidth: 0
                    });
                }
            }
            if (!_64f) {
            ...
            if (col && col.editor) {
                ...
                if (_6e7) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _6e7, target: _6e7.init(cell.find("td"), _6e6), field: _6e4, type: _6e5, oldHtml: _6e8
                    });
                }
            }
        });
    ...
    function _646(_716, _717) {
        ...
        if (opts.pagination) {
            $.extend(_718, {
                page: opts.pageNumber || 1, rows: opts.pageSize
            });
        }
        if (opts.sortName) {
            $.extend(_718, {
    ...
    $.fn.datagrid = function (_71f, _720) {
        ...
        return this.each(function () {
            ...
            if (_721) {
                ...
                }, $.fn.datagrid.defaults, { queryParams: {} }), $.fn.datagrid.parseOptions(this), _71f);
                ...
                $.data(this, "datagrid", {
                    options: opts, panel: _722.panel, dc: _722.dc, ss: null, selectedRows: [], checkedRows: [], data: {
                        total: 0, rows: []
    ...
    $.fn.datagrid.methods = {
        options: function (jq) {
            ...
            var opts = $.extend(_74a, {
                width: _74b.width, height: _74b.height, closed: _74b.closed, collapsed: _74b.collapsed, minimized: _74b.minimized, maximized: _74b.maximized
            });
            return opts;
            ...
            return jq.each(function () {
                ...
                if (opts.loadMsg) {
                    ...
                    if (!_753.children("div.datagrid-mask").length) {
                        ...
                        msg._outerHeight(40);
                        msg.css({
                            marginLeft: (-msg.outerWidth() / 2), lineHeight: (msg.height() + "px")
                        });
                    }
                }
            });
    ...
    var _77a = {
        render: function (_77b, _77c, _77d) {
            ...
            _7c2.find("tbody *").css({
                height: 1, borderColor: "transparent", background: "transparent"
            });
...
(function ($) {
            ...
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_802, row) {
                ...
                if (opts.editIndex != _803) {
                    ...
                    var ed = $(this).datagrid("getEditor", {
                        index: _803, field: _804
                    });
                    if (!ed) {
                        ed = $(this).datagrid("getEditor", {
                            index: _803, field: "value"
                        });
                    }
                    if (ed) {
                        var t = $(ed.target);
    ...
    $.fn.propertygrid.parseOptions = function (_80d) {
        return $.extend({
        }, $.fn.datagrid.parseOptions(_80d), $.parser.parseOptions(_80d, [{
            showGroup: "boolean"
        }]));
    };
    var _80e = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_80f, _810, _811) {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                if (!_829) {
                    _829 = {
                        value: row[opts.groupField], rows: [row]
                    };
                    _828.push(_829);
                } else {
                    _829.rows.push(row);
    ...
    $.extend(_80e, {
        refreshGroupTitle: function (_835, _836) {
            ...
            if (_83c) {
                ...
                _83c = {
                    value: row[opts.groupField], rows: [row], startIndex: _83b.data.rows.length
                };
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        }, { field: "value", title: "Value", width: 100, resizable: false }]], showGroup: false, groupView: _80e, groupField: "group", groupFormatter: function (_84b, rows) {
            return _84b;
        }
    });
})(jQuery);
(function ($) {
    ...
    function _8b2(_8b3, _8b4) {
        ...
        _8ae(_8b3, {
            parent: (_8b5 ? _8b5[opts.idField] : null), data: [_8b4.data]
        });
    ...
    $.fn.treegrid.parseOptions = function (_8d5) {
        return $.extend({
        }, $.fn.datagrid.parseOptions(_8d5), $.parser.parseOptions(_8d5, ["treeField", {
            animate: "boolean"
        }]));
    };
...
(function ($) {
    ...
    $.fn.datalist.parseOptions = function (_93c) {
        return $.extend({
        }, $.fn.datagrid.parseOptions(_93c), $.parser.parseOptions(_93c, ["valueField", "textField", "groupField", {
...
(function ($) {
    ...
    function _942(_943) {
        ...
        if (!_944.panel) {
            ...
            _944.panel.panel({
                minWidth: opts.panelMinWidth, maxWidth: opts.panelMaxWidth, minHeight: opts.panelMinHeight, maxHeight: opts.panelMaxHeight, doSize: false, closed: true, cls: "combo-p", style: {
    ...
    function _959(_95a) {
        ...
        if (_95e.closed) {
            _95d.panel("panel").show().css({
                zIndex: ($.fn.menu ? $.fn.menu.defaults.zIndex++ : $.fn.window.defaults.zIndex++), left: -999999
            });
            _95d.panel("resize", {
                width: (opts.panelWidth ? opts.panelWidth : _95c._outerWidth()), height: opts.panelHeight
            });
        ...
        return this.each(function () {
            ...
            if (_97f) {
                ...
                _97f = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _97c), previousText: ""
                });
    ...
    $.fn.combo.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combo").options, {
                width: opts.width, height: opts.height, disabled: opts.disabled, readonly: opts.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
                $(this).textbox("cloneFrom", from);
                $.data(this, "combo", {
                    options: $.extend(true, { cloned: true }, $(from).combo("options")), combo: $(this).next(), panel: $(from).combo("panel")
                });
    ...
    $.fn.combo.parseOptions = function (_982) {
        var t = $(_982);
        return $.extend({
        }, $.fn.textbox.parseOptions(_982), $.parser.parseOptions(_982, ["separator", "panelAlign", {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {
            click: _952, keydown: _956, paste: _956, drop: _956
        }, panelWidth: null, panelHeight: 200, panelMinWidth: null, panelMaxWidth: null, panelMinHeight: null, panelMaxHeight: null, panelAlign: "left", multiple: false, selectOnNavigation: true, separator: ",", hasDownArrow: true, delay: 200, keyHandler: {
            up: function (e) {
            }, down: function (e) {
            }, left: function (e) {
            }, right: function (e) {
...
(function ($) {
    ...
    $.fn.combobox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combobox").options, {
                width: _9bd.width, height: _9bd.height, originalValue: _9bd.originalValue, disabled: _9bd.disabled, readonly: _9bd.readonly
            });
        }, getData: function (jq) {
    ...
    $.fn.combobox.parseOptions = function (_9c3) {
        var t = $(_9c3);
        return $.extend({
        }, $.fn.combo.parseOptions(_9c3), $.parser.parseOptions(_9c3, ["valueField", "textField", "groupField", "mode", "method", "url"]));
    };
...
(function ($) {
    ...
    $.fn.combotree.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combotree").options, {
                width: _9ed.width, height: _9ed.height, originalValue: _9ed.originalValue, disabled: _9ed.disabled, readonly: _9ed.readonly
            });
    ...
    $.fn.combotree.parseOptions = function (_9f1) {
        return $.extend({
        }, $.fn.combo.parseOptions(_9f1), $.fn.tree.parseOptions(_9f1));
    };
...
(function ($) {
    ...
    $.fn.combogrid.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "combogrid").options, {
                width: _a21.width, height: _a21.height, originalValue: _a21.originalValue, disabled: _a21.disabled, readonly: _a21.readonly
            });
        }, grid: function (jq) {
    ...
    $.fn.combogrid.parseOptions = function (_a25) {
        var t = $(_a25);
        return $.extend({
        }, $.fn.combo.parseOptions(_a25), $.fn.datagrid.parseOptions(_a25), $.parser.parseOptions(_a25, ["idField", "textField", "mode"]));
    };
...
(function ($) {
    ...
    $.fn.datebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datebox").options, {
                width: _a47.width, height: _a47.height, originalValue: _a47.originalValue, disabled: _a47.disabled, readonly: _a47.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
                $(this).combo("cloneFrom", from);
                $.data(this, "datebox", {
                    options: $.extend(true, {}, $(from).datebox("options")), calendar: $(from).datebox("calendar")
                });
    ...
    $.fn.datebox.parseOptions = function (_a4b) {
        return $.extend({
        }, $.fn.combo.parseOptions(_a4b), $.parser.parseOptions(_a4b, ["sharedCalendar"]));
    };
...
(function ($) {
    function _a50(_a51) {
        ...
        _a52.spinner.timespinner({
            width: opts.spinnerWidth, showSeconds: opts.showSeconds, separator: opts.timeSeparator
        });
    ...
    $.fn.datetimebox.methods = {
        options: function (jq) {
            ...
            return $.extend($.data(jq[0], "datetimebox").options, {
                originalValue: _a66.originalValue, disabled: _a66.disabled, readonly: _a66.readonly
            });
        }, cloneFrom: function (jq, from) {
            return jq.each(function () {
                $(this).datebox("cloneFrom", from);
                $.data(this, "datetimebox", {
                    options: $.extend(true, {}, $(from).datetimebox("options")), spinner: $(from).datetimebox("spinner")
                });
    ...
    $.fn.datetimebox.parseOptions = function (_a6a) {
        var t = $(_a6a);
        return $.extend({
        }, $.fn.datebox.parseOptions(_a6a), $.parser.parseOptions(_a6a, ["timeSeparator", "spinnerWidth", {
            showSeconds: "boolean"
        }]));
    };
...
(function ($) {
        ...
        function _a84(aa) {
            ...
            for (var i = 0; i < aa.length; i++) {
                ...
                if (aa[i] != "|") {
                    ...
                    if (opts.mode == "h") {
                        span.css({
                            left: _a86, marginLeft: -Math.round(span.outerWidth() / 2)
                        });
                    } else {
                        span.css({
                            top: _a86, marginTop: -Math.round(span.outerHeight() / 2)
                        });
                    }
                }
            }
        ...
        return this.each(function () {
            ...
            if (_aa9) {
                ...
                _aa9 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _aa7), slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_aad) {
        var t = $(_aad);
        return $.extend({
        }, $.parser.parseOptions(_aad, ["width", "height", "mode", { reversed: "boolean", showTip: "boolean", range: "boolean", min: "number", max: "number", step: "number" }]), { value: (t.val() || undefined), disabled: (t.attr("disabled") ? true : undefined), rule: (t.attr("rule") ? eval(t.attr("rule")) : undefined) });
    };
    $.fn.slider.defaults = {
