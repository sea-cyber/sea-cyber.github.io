...
; (function ($) {
    ...
    dev.initmaptool = function () {
        //放置工具箱
        var toolsDiv = $('<div class="toolcontainer" style=" position: absolute;top:18px;height:30px;width:30px;right:75px;cursor:pointer;z-index:9999;"></div>');
        ...
        //初始化专题图层图标
        var tipicPanel;
        var topic = $('<div class="topiccontainer" style="width:30px;height:30px;position:absolute;top:18px;right:110px;background:rgba(0,0,0,0.4);border:1px solid #999;cursor:pointer;z-index:9999;"><div style="width:16px;height:16px; margin-left: 7px; margin-top: 7px;" class="icon icon-maptool-topic"></div></div>');
